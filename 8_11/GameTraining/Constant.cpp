...
float ALD_VY_JUMP = 0.4; // Van toc Vy cua aladin khi nhay
float ALD_V_RUN = 0.08; // Van toc chay cua aladin
float ALD_VX_STAND = 0; // van toc Vx khi aladin dung 1 chofloat 
int CAMERA_CHANGEMAPVIEW_DY = 3; // ...
float ALADIN_CHANGEMAPVIEW_DY = 0.3;

int CAMERA_CHANGESTAGEVIEW_DY = 3; // ...
float ROCKMAN_CHANGESTAGEVIEW_DY = 0.3;
